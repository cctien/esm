...
import fairesm
from fairesm.model.esm2 import ESM2
...
def _load_model_and_alphabet_core_v1(model_data):
    import fairesm  # since esm.inverse_folding is imported below, you actually have to re-import fairesm here
...
def esmfold_v0():
    ...
    """
    import fairesm.esmfold.v1.pretrained
